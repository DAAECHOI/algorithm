...
function forgotPwd() {
	if(document.getElementById("hintid").value == "") {
		...
		document.getElementById("forgotform").action = "${root}/forgotpwd.do";
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					<li class="nav-item">
						<a class="nav-link js-scroll-trigger" href='${ctx}search.do'>검색</a>
					</li>
					<li class="nav-item">
						<a class="nav-link js-scroll-trigger" href='${ctx}listAirPolution.do'>동네 업종/대기오염 정보</a>
					</li>
					<c:choose>
						<c:when test="${empty id}">
							...
							<li class="nav-item">
								<a class="nav-link js-scroll-trigger" href='${ctx}join.do'>회원가입</a>
							</li>
						</c:when>
						<c:otherwise>
							<li class="nav-item">
								<a class="nav-link js-scroll-trigger" href='${ctx}logout.do'>로그아웃</a>
							</li>
							<li class="nav-item">
								<a class="nav-link js-scroll-trigger" href="${ctx}memberInfo.log">회원정보</a>
							</li>
						</c:otherwise>
					</c:choose>
				</ul>
