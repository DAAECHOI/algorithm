	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(input == 0) {
				...
				if(mgr.add(p)) {
					System.out.println(p.getName() + "이 저장되었습니다.");
				}
				else {
					System.out.println(p.getName() + "은/는 이미 등록된 상품입니다.");
				}
			}
			else if(input == 2) {
				...
				product = mgr.list(no);
				if(product != null) {
					System.out.println(no + "번에 해당하는 상품입니다.");
				...
				System.out.print("400L 이상의  Refrigerator 리스트입니다.");
				products = mgr.list400Refrigerator();
				System.out.println(products);
			}
			else if(input == 8) {
				System.out.print("50inch 이상의 TV 리스트입니다.");
...
//		Product prd4 = new Refrigerator(44, "어디 냉장고", 700000, 8, 500);
...
//		}
//		else {
//			System.out.println(prd1.getName() + "은/는 이미 등록된 상품입니다.");
//		}
//		if(mgr.add(prd2)) {
//			System.out.println(prd2.getName() + "이/가 저장되었습니다.");
//		}
//		else {
//			System.out.println(prd2.getName() + "은/는 이미 등록된 상품입니다.");
//		}
//		if(mgr.add(prd3)) {
//			System.out.println(prd3.getName() + "이/가 저장되었습니다.");
//		}
//		else {
//			System.out.println(prd3.getName() + "은/는 이미 등록된 상품입니다.");
//		}
//		if(mgr.add(prd4)) {
//			System.out.println(prd4.getName() + "이/가 저장되었습니다.");
//		}
//		else {
//			System.out.println(prd4.getName() + "은/는 이미 등록된 상품입니다.");
//		}
//		if(mgr.add(prd5)) {
//			System.out.println(prd5.getName() + "이/가 저장되었습니다.");
//		}
//		else {
//			System.out.println(prd5.getName() + "은/는 이미 등록된 상품입니다.");
//		}
//		
//		System.out.println("전체 상품 리스트입니다.");
//		products = mgr.list();
