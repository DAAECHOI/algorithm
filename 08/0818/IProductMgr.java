...
public interface IProductMgr {
	...
	boolean add(Product p) throws DuplicateException;//상품정보를 저장

	List<Product> list();//상품정보 전체
	
	Product list(int num) throws CodeNotFoundException;//상품번호로 상품을 검색
	...
	List<Product> list400Refrigerator() throws ProductNotFoundException;//400L 이상의 Refrigerator 검색
	
	List<Product> list50TV() throws ProductNotFoundException; //50inch 이상의 TV정보만 검색
